...
/>
  ...
  <div
    style={{
      ...
      gap: "70px",
      alignItems: "center", // changed from stretch to center for your alignment
    }}
  ...
  >
    ...
    <div>
      ...
      <p style={{ color: "#475569", fontSize: ".95rem", lineHeight: "1.9", marginBottom: "18px" }}>
      ...
      <p style={{ color: "#475569", fontSize: ".95rem", lineHeight: "1.9" }}>
  ...
  {/* Hover + Fully Responsive - Server Safe */}
  <style>{`
    .our-story-img-wrap {
      width: 100%;
      border-radius: 12px;
...
<section style={{ background: "#ffffff", padding: "40px 20px", position: "relative", overflow: "hidden" }}>
  {/* Subtle Premium Pattern on White */}
  ...
  <div style={{ maxWidth: "1300px", width: "100%", margin: "0 auto", position: "relative", zIndex: 1 }}>
    ...
    <div style={{ textAlign: "center", marginBottom: "60px" }}>
      ...
      <h2 style={{ color: "#0b1e48", fontSize: "2.8rem", fontWeight: "800", lineHeight: "1.1", margin: "0 0 16px" }} className="premium-heading-white">
        Built on Trust, Driven by Excellence
      </h2>
      <p style={{ color: "#64748b", fontSize: "1.05rem", maxWidth: "600px", margin: "0 auto" }}>Three pillars that define how we move your world forward</p>
    </div>
    ...
    <div className="premium-grid-white">
      ...
      <div className="premium-card-white">
        ...
        <h3>Our Mission</h3>
        <p>To provide safe auto transport while exceeding customer expectations through professionalism, transparency, and modern technology.</p>
      ...
      <div className="premium-card-white">
        ...
        <h3>Our Vision</h3>
        <p>To lead the auto transport industry with innovative technology, simplifying the shipping process and delivering maximum convenience and satisfaction.</p>
        <div className="card-line-white"></div>
      </div>
...
<section style={{ background: "#fff", padding: "40px 20px" }}>
  <div style={{ maxWidth: "1300px", width: "100%", margin: "0 auto" }}>
    ...
    <div className="why-lux-wrap">
      ...
      <div className="why-lux-left">
        <div>
          <h2>Stateside  <span>Auto Ship?</span></h2>
          <div className="why-lux-line"></div>
          <p>Trusted by thousands for safe, reliable vehicle shipping across 48 states.</p>
        </div>
      ...
      <div className="why-lux-right">
        <div className="why-card">
          ...
          <div><h3>Dedicated Expertise</h3><p>Every vehicle is assigned a dedicated expert agent who coordinates every step from pickup to delivery, ensuring professional handling and real-time updates.</p></div>
        </div>
        <div className="why-card">
          ...
          <div><h3>Trusted Carrier Network</h3><p>Our carriers are carefully vetted for auto liability coverage, cargo insurance, driving history, and safety ratings to safeguard your vehicle.</p></div>
        </div>
        <div className="why-card">
          ...
          <div><h3>Advanced Technology</h3><p>Our powerful cost calculator provides accurate vehicle shipping estimates in seconds — for free, with transparent pricing and no hidden fees.</p></div>
        </div>
        <div className="why-card">
          ...
          <div><h3>5-Star & BBB Accredited</h3><p>FMCSA and DOT licensed <b>MC:1304594, DOT:3713977</b> with proven reliability and thousands of successful deliveries across 48 states.</p></div>
        </div>
      </div>
  ...
  <style>{`
    ...
    .why-lux-left h2 span { color: #d90429; display: block; }
    .why-lux-line { width: 52px; height: 4px; background: #d90429; margin: 20px 0; border-radius: 100px; }
    .why-lux-left p { color: #64748b; font-size: 0.95rem; line-height: 1.6; margin: 0; max-width: 340px; }
    .why-lux-img {
      margin-top: 28px;
      border-radius: 20px;
      overflow: hidden;
    ...
    .why-lux-img-badge {
      ...
      font-size: 11px; font-weight: 800; color: #031b4e; display: flex; gap: 6px; align-items: center;
    }
    ...
    .why-card h3 { color: #031b4e; font-size: 1.05rem; font-weight: 800; margin: 0 0 6px; }
    .why-card p { color: #5b6d86; font-size: 0.88rem; line-height: 1.65; margin: 0; }
    .why-card b { color: #031b4e; }

    @media (max-width: 1024px) {
      .why-lux-wrap { grid-template-columns: 1fr; gap: 28px; }
      .why-lux-left { height: auto; }
      .why-lux-left h2 { max-width: 100%; font-size: 2.6rem; }
      .why-lux-img { min-height: 300px; flex: none; height: 300px; }
      .why-lux-right { height: auto; }
      .why-card { flex: none; }
    }
    @media (max-width: 640px) {
      .why-lux-left h2 { font-size: 1.85rem; max-width: 260px; }
...
<section style={{ background: "#031b4e", padding: "60px 20px" }}>
  <div style={{ maxWidth: "1300px", width: "100%", margin: "0 auto" }}>
    ...
    <div className="balanced-grid">
      ...
      <div className="bal-card">
        ...
        <p><b>Our carriers are carefully vetted by our dedicated carrier compliance team. We check:</b></p>
        <div className="bal-pills"><span>Auto liability</span><span>Cargo insurance</span><span>Safety ratings</span></div>
        <p>This pre-vetting ensures that every vehicle is in reliable hands, minimizing risks and safeguarding your investment.</p>
      ...
      <div className="bal-card">
        ...
        <p><b>We have implemented a powerful, advanced cost calculator that provides accurate vehicle shipping estimates in seconds — for free. This tool allows customers to:</b></p>
      ...
      <div className="bal-card">
        ...
        <p><b>Our value is simple: customer satisfaction drives everything we do. We treat every vehicle as if it were our own and every customer as part of our family.</b></p>
        <ul>
          <li>Estimates are provided first, followed by a final cost confirmation before assigning a load, ensuring pricing is affordable and transparent even in a fluctuating market.</li>
          <li>Our dedicated agents maintain constant communication, providing updates and guidance at every stage.</li>
          <li>Customers enjoy a smooth and professional shipping experience from start to finish.</li>
        </ul>
      ...
      <div className="bal-card">
        ...
        <p>We are fully licensed for FMCSA and DOT (MC:1304594, DOT:3713977) operations, BBB accredited and maintain all active certifications required to operate legally and safely in the auto transport industry.</p>
  ...
  <style>{`
    ...
    .bal-card h3 { color: #031b4e; font-size: 1.15rem; font-weight: 800; margin: 0; line-height: 1.2; flex: 1; }
    .bal-card p { color: #475569; font-size: 0.88rem; line-height: 1.65; margin: 0 0 12px; }
    .bal-card b { color: #1e293b; }
    ...
    .bal-card ul li { position: relative; padding-left: 16px; font-size: 0.85rem; color: #475569; line-height: 1.6; margin-bottom: 8px; }
    ...
    .bal-foot.dark { background: #031b4e; color: #e2e8f0; }
    .bal-badges { display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 14px; }
    .bal-badges b { background: #031b4e; color: #fff; padding: 5px 12px; border-radius: 100px; font-size: 11px; }
...
<section style={{ background: "#fff", padding: "40px 20px 60px 20px" }}>
  <div style={{ maxWidth: "1300px", width: "100%", margin: "0 auto" }}>
    ...
    <div className="white-glance">
      ...
      <div className="w-item">
        ...
        <div><h4>16,000+</h4><p>vehicles shipped in 48 states</p></div>
      ...
      <div className="w-item">
        ...
        <div><h4>5-Star Rated</h4><p>service with BBB accreditation</p></div>
        <div className="w-check">✓</div>
      </div>
      ...
      <div className="w-item">
        ...
        <div><h4>Dedicated Experts</h4><p>for every shipment</p></div>
        <div className="w-check">✓</div>
      </div>
      ...
      <div className="w-item">
        ...
        <div><h4>Pre-Vetted</h4><p>licensed, and insured carriers</p></div>
        <div className="w-check">✓</div>
      </div>
      ...
      <div className="w-item">
        ...
        <div><h4>Advanced Calculator</h4><p>for instant estimates</p></div>
        <div className="w-check">✓</div>
      </div>
      ...
      <div className="w-item">
        ...
        <div><h4>Coast-to-Coast</h4><p>coverage and fast availability</p></div>
        <div className="w-check">✓</div>
      </div>
      ...
      <div className="w-item">
        ...
        <div><h4>Customer First</h4><p>satisfaction as the core value</p></div>
        <div className="w-check">✓</div>
      </div>
      ...
      <div className="w-item">
        ...
        <div><h4>Transparent Pricing</h4><p>with no hidden fees</p></div>
        <div className="w-check">✓</div>
      </div>
  ...
  <style>{`
    ...
    .glance-top h2 span { color: #d90429; }
    .glance-btn {
      display: inline-flex;
      align-items: center;
      gap: 10px;
    ...
    .w-item h4 { color: #031b4e; font-size: 13.5px; font-weight: 800; margin: 0 0 2px; line-height: 1.2; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .w-item p { color: #64748b; font-size: 11.5px; margin: 0; line-height: 1.3; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    ...
    .w-item:hover .w-check { background: #031b4e; color: #fff; }
    ...
    @media (max-width: 900px) {
      ...
      .glance-top h2 { font-size: 2rem; }
    }
    @media (max-width: 560px) {
      .white-glance { grid-template-columns: 1fr; }
      .glance-top { flex-direction: column; align-items: flex-start; }
      .glance-top h2 { font-size: 1.8rem; }
      .w-item p { white-space: normal; }
      .w-item h4 { white-space: normal; }
    }
  `}</style>
</section>
...
>
  ...
  <p style={{ fontSize: "17px", color: "#ddd", marginBottom: "30px" }}>
