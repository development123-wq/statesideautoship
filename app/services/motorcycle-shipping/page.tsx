...
const myFaqs = [
  { 
    id: 1, 
    question: "How is my motorcycle secured during transport?", 
    answer: "We use soft tie-down straps that won't damage your bike's finish, along with wheel chocks to keep it stable. The bike is never secured by handlebars or other delicate parts." 
  },
  { 
    id: 2, 
    question: "Should I choose open or enclosed transport?", 
    answer: "Open transport is economical for most bikes. Enclosed transport is recommended for high-value, custom, or vintage motorcycles that need extra protection from weather and road debris." 
  },
  { 
    id: 3, 
    question: "How long does motorcycle shipping take?", 
    answer: "Typical delivery times range from 1-7 days depending on distance. Cross-country shipments take 5-7 days, while regional transport can be completed in 1-3 days." 
  },
  { 
    id: 4, 
    question: "Do I need to drain the fuel tank?", 
    answer: "No, you should leave about 1/4 tank of fuel. This is enough for loading and unloading but reduces weight and fire risk during transport." 
  },
  { 
    id: 5, 
    question: "Can you ship custom or modified motorcycles?", 
    answer: "Yes, we regularly ship custom and modified bikes. Just provide accurate dimensions and any special handling requirements when requesting your quote." 
  },
];
...
export default function AboutUsPage() {
  return (
    <main>
      ...
      {/* HOW MOTORCYCLE SHIPPING WORKS - HEADING CENTER ONLY */}
  <section
  style={{
    width: "100%",
...
>
  <style>{`
    ...
    @media(max-width:600px){ .hsw2-grid{grid-template-columns:1fr !important} .hsw2-title{font-size:26px !important} }
  `}</style>

  <div style={{ maxWidth:"1300px", margin:"0 auto" }}>

    <div style={{ textAlign:"center", margin:"0 auto 30px", maxWidth:"1000px" }}>
      <h2 className="hsw2-title" style={{ fontSize:"2.8rem", fontWeight:800, color:"#0b1e48", margin:0, lineHeight:1.15, letterSpacing:"-0.6px", textAlign:"center" }}>How Motorcycle Shipping Works?</h2>
      <p style={{ fontSize:"16px", color:"#475569", margin:"8px 0 0", lineHeight:1.6, textAlign:"center" }}>Our streamlined process ensures your vehicle is transported safely and efficiently</p>
    </div>
    ...
    <div className="hsw2-grid" style={{ display:"grid", gridTemplateColumns:"repeat(4, 1fr)", gap:"18px" }}>
      ...
      <div className="hsw2-card" style={{ background:"#f8fafc", border:"1px solid #eef2f7", borderRadius:"18px", padding:"22px 20px" }}>
        ...
        <p style={{ margin:0, fontSize:"13.5px", color:"#475569", lineHeight:1.6 }}>Provide your motorcycle details, pickup and delivery locations. Get an instant customized quote for your bike transport.</p>
      </div>
      ...
      <div className="hsw2-card" style={{ background:"#ffffff", border:"1px solid #e2e8f0", borderRadius:"18px", padding:"22px 20px", boxShadow:"0 8px 24px rgba(6,45,87,.04)" }}>
        ...
        <p style={{ margin:0, fontSize:"13.5px", color:"#475569", lineHeight:1.6 }}>Choose your preferred transport method and pickup date. We'll match you with a specialized motorcycle carrier.</p>
      </div>
      ...
      <div className="hsw2-card" style={{ background:"#f8fafc", border:"1px solid #eef2f7", borderRadius:"18px", padding:"22px 20px" }}>
        ...
        <p style={{ margin:0, fontSize:"13.5px", color:"#475569", lineHeight:1.6 }}>Your motorcycle is carefully secured using soft straps and wheel chocks. Professional handling ensures zero damage.</p>
      </div>
      ...
      <div className="hsw2-card" style={{ background:"#0b1e48", border:"1px solid #062d57", borderRadius:"18px", padding:"22px 20px" }}>
        ...
        <p style={{ margin:0, fontSize:"13.5px", color:"#94a3b8", lineHeight:1.6 }}>Your bike arrives safely at your destination. Final inspection and handover at your specified location.</p>
      </div>
...
<section style={{ width:"100%", padding:"40px 20px", background:"#ffffff", fontFamily:"'Inter', sans-serif", boxSizing:"border-box" }}>
  ...
  <div className="rv2-grid" style={{ maxWidth:"1300px", margin:"0 auto", display:"grid", gridTemplateColumns:"360px 1fr", gap:"40px", alignItems:"start" }}>
    ...
    <div className="rv2-left" style={{ position:"sticky", top:"90px" }}>
      <h2 style={{ fontSize:"2.8rem", fontWeight:800, color:"#0b1e48", lineHeight:1.15, margin:"0 0 12px", letterSpacing:"-0.6px" }}>
        Nationwide Auto Transport Made Simple
      </h2>
      <p style={{ fontSize:"16px", fontWeight:400, color:"#475569", lineHeight:1.6, margin:"0 0 20px" }}>
        Trusted motorcycle shipping for riders, dealerships, and collectors across all 50 states.
      </p>
    ...
    <div style={{ display:"grid", gap:"18px" }}>
      ...
      <div className="rv2-card" style={{ background:"#f8fafc", borderRadius:"16px", padding:"22px", border:"1px solid #eef2f7", display:"grid", gridTemplateColumns:"48px 1fr", gap:"16px" }}>
        ...
        <div>
          ...
          <p style={{ margin:0, fontSize:"14px", fontWeight:400, color:"#475569", lineHeight:1.7 }}>The motorcycle shipping industry in the US provides a safe and convenient way for riders, dealerships, and collectors to transport bikes nationwide. Licensed carriers offer both open and enclosed shipping options for every distance and budget.</p>
        </div>
      </div>
      ...
      <div className="rv2-card" style={{ background:"#ffffff", borderRadius:"16px", padding:"22px", border:"1px solid #e2e8f0", boxShadow:"0 8px 24px rgba(6,45,87,.05)", display:"grid", gridTemplateColumns:"48px 1fr", gap:"16px" }}>
        ...
        <div>
          ...
          <p style={{ margin:0, fontSize:"14px", fontWeight:400, color:"#475569", lineHeight:1.7 }}>You request a quote with your motorcycle details and pickup/delivery locations. After booking, a carrier is assigned, inspection is done, and the bike is securely loaded. Customers receive updates during transit, and a final inspection is done at delivery.</p>
        </div>
      </div>
      ...
      <div className="rv2-card" style={{ background:"#0b1e48", borderRadius:"16px", padding:"22px", border:"1px solid #0b1e48", display:"grid", gridTemplateColumns:"48px 1fr", gap:"16px" }}>
        ...
        <div>
          ...
          <p style={{ margin:0, fontSize:"14px", fontWeight:400, color:"#ffffff", lineHeight:1.7 }}>United Freeway Transportation connects you with trusted fully insured motorcycle carriers nationwide. We provide personalized service, transparent pricing, and instant estimates for standard bikes, custom builds, and luxury motorcycles.</p>
        </div>
      </div>
        ...
        <div style={{ maxWidth: "1300px", margin: "0 auto" }}>
          ...
          >
            <div>
              ...
              >
                ...
                <span style={{ color: "#d60000" }}>Ship a Motorcycle</span>?
              </h2>
            </div>
          </div>
          ...
          >
            <div className="cost-card" style={{ background: "#fff", borderRadius: "16px", padding: "22px 20px", boxShadow: "0 8px 24px rgba(11,30,72,.05)", border: "1px solid #eef2f7" }}>
              ...
              <p style={{ margin: 0, fontSize: "13.5px", color: "#475569", lineHeight: 1.6 }}>Longer distances typically cost more, but the per-mile rate decreases for longer trips.</p>
            </div>
            ...
            <div className="cost-card" style={{ background: "#fff", borderRadius: "16px", padding: "22px 20px", boxShadow: "0 8px 24px rgba(11,30,72,.05)", border: "1px solid #eef2f7" }}>
              ...
              <p style={{ margin: 0, fontSize: "13.5px", color: "#475569", lineHeight: 1.6 }}>Larger vehicles like SUVs and trucks cost more to ship than compact cars.</p>
            </div>
            ...
            <div className="cost-card" style={{ background: "#fff", borderRadius: "16px", padding: "22px 20px", boxShadow: "0 8px 24px rgba(11,30,72,.05)", border: "1px solid #eef2f7" }}>
              ...
              <p style={{ margin: 0, fontSize: "13.5px", color: "#475569", lineHeight: 1.6 }}>Enclosed transport costs 30-40% more than open transport but offers maximum protection.</p>
            </div>
            ...
            <div className="cost-card" style={{ background: "#fff", borderRadius: "16px", padding: "22px 20px", boxShadow: "0 8px 24px rgba(11,30,72,.05)", border: "1px solid #eef2f7" }}>
              ...
              <p style={{ margin: 0, fontSize: "13.5px", color: "#475569", lineHeight: 1.6 }}>Summer months and flexible scheduling can help you save on shipping costs.</p>
            </div>
          </div>
        </div>
      </section>
