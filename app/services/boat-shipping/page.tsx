...
{/* HOW BOAT SHIPPING WORKS - TEMPLATE MATCHED */}
<section
  style={{
    width: "100%",
    padding: "40px 20px",
...
>
  <style>{`
    ...
    @media(max-width:600px){ .hsw-grid{grid-template-columns:1fr !important} .hsw-title{font-size:26px !important} }
  `}</style>
  ...
  <div style={{ maxWidth:"1300px", margin:"0 auto" }}>
    <div style={{ textAlign: "left", maxWidth: "100%", margin: "0 0 30px" }}>
      ...
      <p style={{ fontSize: "16px", color: "#475569", margin: 0, lineHeight: 1.6, maxWidth:"100%" }}>
    ...
    <div className="hsw-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "30px" }}>
      {[
        ...
        <div key={s.n} className="hsw-card" style={{ position: "relative", background: "#f8fafc", borderRadius: "20px", padding: "30px 24px 28px", boxShadow: "0 10px 30px rgba(11,30,72,0.04)", border: "1px solid #eef2f7", textAlign: "left" }}>
          ...
          <p style={{ margin: 0, fontSize: "13.5px", color: "#475569", lineHeight: 1.6 }}>{s.d}</p>
        </div>
      ))}
    </div>
  </div>
...
{/* NATIONWIDE AUTO - TEMPLATE MATCHED */}
  ...
  <div className="rv2-grid" style={{ maxWidth:"1300px", margin:"0 auto", display:"grid", gridTemplateColumns:"360px 1fr", gap:"40px", alignItems:"start" }}>
    <div className="rv2-left" style={{ position:"sticky", top:"90px" }}>
      ...
      <p style={{ fontSize:"16px", fontWeight:400, color:"#475569", lineHeight:1.6, margin:"0 0 20px" }}>
        Trusted boat shipping for private owners, marinas, dealers, and marine businesses across all 50 states.
      </p>
    ...
    <div style={{ display:"grid", gap:"18px" }}>
      <div className="rv2-card" style={{ background:"#f8fafc", borderRadius:"16px", padding:"22px", border:"1px solid #eef2f7", display:"grid", gridTemplateColumns:"48px 1fr", gap:"16px" }}>
        ...
        <div>
          ...
          <p style={{ margin:0, fontSize:"14px", fontWeight:400, color:"#475569", lineHeight:1.7 }}>The boat shipping industry in the US helps private owners, marinas, dealers, and marine businesses move small boats to large yachts nationwide. Licensed carriers offer overland trailer transport, enclosed shipping, and specialized marine handling.</p>
        </div>
      </div>
      <div className="rv2-card" style={{ background:"#ffffff", borderRadius:"16px", padding:"22px", border:"1px solid #e2e8f0", boxShadow:"0 8px 24px rgba(11,30,72,.05)", display:"grid", gridTemplateColumns:"48px 1fr", gap:"16px" }}>
        ...
        <div>
          ...
          <p style={{ margin:0, fontSize:"14px", fontWeight:400, color:"#475569", lineHeight:1.7 }}>You request a quote with boat size, weight, and route. After booking, a specialized carrier performs inspection and prepares the vessel for transit. Customers receive updates until final inspection at delivery.</p>
        </div>
      </div>
      <div className="rv2-card" style={{ background:"#0b1e48", borderRadius:"16px", padding:"22px", border:"1px solid #0b1e48", display:"grid", gridTemplateColumns:"48px 1fr", gap:"16px" }}>
        ...
        <div>
          ...
          <p style={{ margin:0, fontSize:"14px", fontWeight:400, color:"#ffffff", lineHeight:1.7 }}>UFT connects marine clients with experienced boat transporters nationwide — providing accurate pricing, instant quotes, and dedicated coordination for safe, stress-free shipping of any vessel type.</p>
        </div>
      </div>
    </div>
  </div>
...
{/* HOW MUCH DOES IT COST - TEMPLATE MATCHED */}
<section style={{ width: "100%", padding: "40px 20px", background: "#f8fafc", fontFamily: "'Inter', sans-serif", boxSizing: "border-box" }}>
  ...
  <div style={{ maxWidth: "1300px", margin: "0 auto" }}>
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "end", gap: "20px", flexWrap: "wrap", marginBottom: "36px" }}>
      <div>
        <h2 className="cost-title" style={{ fontSize: "2.8rem", fontWeight: 800, color: "#0b1e48", margin: 0, lineHeight: 1.15, letterSpacing: "-0.6px" }}>
    ...
    <div className="cost-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "20px" }}>
      <div className="cost-card" style={{ background: "#fff", borderRadius: "16px", padding: "22px 20px", boxShadow: "0 8px 24px rgba(11,30,72,.05)", border: "1px solid #eef2f7" }}>
        ...
        <p style={{ margin: 0, fontSize: "13.5px", color: "#475569", lineHeight: 1.6 }}>Larger boats require specialized trailers and may need permits, significantly affecting transport costs.</p>
      </div>
      <div className="cost-card" style={{ background: "#fff", borderRadius: "16px", padding: "22px 20px", boxShadow: "0 8px 24px rgba(11,30,72,.05)", border: "1px solid #eef2f7" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "18px" }}>
          <div className="cost-icon" style={{ width: "44px", height: "44px", background: "#0b1e48", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <p style={{ margin: 0, fontSize: "13.5px", color: "#475569", lineHeight: 1.6 }}>Longer distances cost more, but per-mile rates decrease for cross-country boat transport.</p>
      </div>
      <div className="cost-card" style={{ background: "#fff", borderRadius: "16px", padding: "22px 20px", boxShadow: "0 8px 24px rgba(11,30,72,.05)", border: "1px solid #eef2f7" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "18px" }}>
          <div className="cost-icon" style={{ width: "44px", height: "44px", background: "#0b1e48", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <p style={{ margin: 0, fontSize: "13.5px", color: "#475569", lineHeight: 1.6 }}>Overland transport, yacht shipping, or containerized shipping each have different cost structures.</p>
      </div>
      <div className="cost-card" style={{ background: "#fff", borderRadius: "16px", padding: "22px 20px", boxShadow: "0 8px 24px rgba(11,30,72,.05)", border: "1px solid #eef2f7" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "18px" }}>
          <div className="cost-icon" style={{ width: "44px", height: "44px", background: "#0b1e48", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <p style={{ margin: 0, fontSize: "13.5px", color: "#475569", lineHeight: 1.6 }}>Oversized boats may require special permits and pilot vehicles, adding to the total cost.</p>
      </div>
    </div>
  </div>
</section>
