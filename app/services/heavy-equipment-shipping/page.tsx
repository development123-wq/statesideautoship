...
const myFaqs = [
  { id: 1, question: "What types of heavy equipment can you ship?", answer: "We ship all types of construction and agricultural equipment including excavators, bulldozers, cranes, tractors, forklifts, and more." },
  { id: 2, question: "Do you handle oversized equipment?", answer: "Yes, we specialize in oversized and overweight equipment transport. We handle all necessary permits and route planning for legal compliance." },
  { id: 3, question: "How is heavy equipment secured during transport?", answer: "We use heavy-duty chains, binders, and specialized securing equipment rated for the weight and size of your machinery." },
  { id: 4, question: "Can you ship inoperable equipment?", answer: "Yes, we can transport non-running equipment using specialized loading equipment like forklifts or cranes. Additional fees may apply." },
  { id: 5, question: "How long does heavy equipment shipping take?", answer: "Transit times vary based on distance and permit requirements. Typical shipments take 3-10 days, with oversized loads potentially taking longer due to routing restrictions." },
];
...
<section style={{ width: "100%", padding: "40px 20px", background: "#f8fbff", fontFamily: "'Inter', sans-serif", boxSizing: "border-box" }}>
  <style>{`
    ...
    .hsw-title{color:#0b1e48 !important;font-size:44px !important;font-weight:800 !important;line-height:1.1 !important;letter-spacing:-0.5px !important;margin:0 0 10px !important}
  ...
  <div style={{ maxWidth:"1300px", margin:"0 auto" }}>
    <div style={{ textAlign: "left", maxWidth: "100%", margin: "0 0 40px" }}>
      <h2 className="hsw-title">How Heavy Equipment Shipping Works?</h2>
    ...
    <div className="hsw-grid" style={{ maxWidth: "1300px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "30px" }}>
      {[
        { n: "01", t: "Equipment Assessment", d: "Provide detailed equipment specifications including dimensions, weight, and special requirements. Get a comprehensive transport quote.", i: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2 14 8 20 8 M16 13H8 M16 17H8 M10 9H8" },
        { n: "02", t: "Logistics Planning", d: "Our team arranges specialized trailers, permits, and route planning for your heavy equipment transport.", i: "M1 6v16l7-4 8 4V6l-8-4-7 4z M8 2v16 M16 6v16" },
        { n: "03", t: "Expert Loading", d: "Professional operators use specialized equipment to safely load and secure your machinery for transport.", i: "M1 3h15v13H1z M16 8h4l3 6v5h-7V8z M5.5 18.5a2.5 2.5 0 1 0 0 1 2.5 2.5 0 0 0 0-1z M18.5 18.5a2.5 2.5 0 1 0 0 1 2.5 2.5 0 0 0 0-1z" },
        { n: "04", t: "Secure Delivery", d: "Your equipment arrives safely at the job site or destination. Professional unloading and placement as needed.", i: "M22 11.08V12a10 10 0 1 1-5.93-9.14 M22 4 12 14.01 9 11.01" },
      ].map((s) => (
...
<section style={{ width:"100%", padding:"40px 20px", background:"#ffffff", fontFamily:"'Inter', sans-serif", boxSizing:"border-box" }}>
  ...
  <div className="rv2-grid" style={{ maxWidth:"1300px", margin:"0 auto", display:"grid", gridTemplateColumns:"360px 1fr", gap:"40px", alignItems:"start" }}>
    <div className="rv2-left" style={{ position:"sticky", top:"90px" }}>
      ...
      <p className="rv2-desc" style={{ margin:"0 0 20px" }}>Trusted heavy equipment shipping for construction, agriculture, and industrial operations across all 50 states.</p>
      <div style={{ background:"#f8fafc", border:"1px solid #e2e8f0", borderRadius:"12px", padding:"12px 14px", display:"flex", alignItems:"center", gap:"10px" }}>
        ...
        <div>
          <div style={{ fontSize:"13px", fontWeight:700, color:"#0b1e48" }}>Heavy Equipment - 50 States</div>
          <div style={{ fontSize:"11px", color:"#475569" }}>Excavators, bulldozers & more</div>
        </div>
      </div>
    </div>
    <div style={{ display:"grid", gap:"18px" }}>
      <div className="rv2-card" style={{ background:"#f8fafc", borderRadius:"16px", padding:"22px", border:"1px solid #eef2f7", display:"grid", gridTemplateColumns:"48px 1fr", gap:"16px" }}>
        ...
        <div>
          <h3 style={{ margin:"0 0 8px", fontSize:"16px", fontWeight:700, color:"#0b1e48" }}>Nationwide Heavy Equipment Shipping Made Simple</h3>
          <p className="rv2-desc">Heavy equipment shipping supports construction, agriculture, and industrial operations. Certified carriers move excavators, bulldozers, tractors, forklifts, and more using flatbed, step-deck, and lowboy trailers across the US.</p>
        </div>
      </div>
      <div className="rv2-card" style={{ background:"#ffffff", borderRadius:"16px", padding:"22px", border:"1px solid #e2e8f0", boxShadow:"0 8px 24px rgba(6,45,87,.05)", display:"grid", gridTemplateColumns:"48px 1fr", gap:"16px" }}>
        ...
        <div>
          <h3 style={{ margin:"0 0 8px", fontSize:"16px", fontWeight:700, color:"#0b1e48" }}>How the Heavy Equipment Shipping Process Works</h3>
          <p className="rv2-desc">You request a quote with dimensions, weight, and route. After booking, a suitably equipped carrier is assigned and performs inspection, secure loading, and transit updates. A final inspection happens at delivery.</p>
        </div>
      </div>
  ...
  <div style={{ maxWidth: "1300px", margin: "0 auto" }}>
    ...
    <div className="cost-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "20px" }}>
      <div className="cost-card" style={{ background: "#fff", borderRadius: "16px", padding: "22px 20px", boxShadow: "0 8px 24px rgba(11,30,72,.05)", border: "1px solid #eef2f7" }}>
        ...
        <p className="cost-desc">Larger equipment requires specialized trailers and may need permits, significantly affecting cost.</p>
      </div>
      <div className="cost-card" style={{ background: "#fff", borderRadius: "16px", padding: "22px 20px", boxShadow: "0 8px 24px rgba(11,30,72,.05)", border: "1px solid #eef2f7" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "18px" }}>
          <div className="cost-icon" style={{ width: "44px", height: "44px", background: "#0b1e48", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <p className="cost-desc">Heavier machinery requires stronger trailers and may have route restrictions, impacting pricing.</p>
      </div>
      <div className="cost-card" style={{ background: "#fff", borderRadius: "16px", padding: "22px 20px", boxShadow: "0 8px 24px rgba(11,30,72,.05)", border: "1px solid #eef2f7" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "18px" }}>
          <div className="cost-icon" style={{ width: "44px", height: "44px", background: "#0b1e48", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <p className="cost-desc">Long-distance heavy equipment transport costs more but offers economies of scale for cross-country moves.</p>
      </div>
      <div className="cost-card" style={{ background: "#fff", borderRadius: "16px", padding: "22px 20px", boxShadow: "0 8px 24px rgba(11,30,72,.05)", border: "1px solid #eef2f7" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "18px" }}>
          <div className="cost-icon" style={{ width: "44px", height: "44px", background: "#0b1e48", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <p className="cost-desc">Oversized loads, permits, escorts, and specialized loading equipment add to the total cost.</p>
      </div>
    </div>
  </div>
</section>
