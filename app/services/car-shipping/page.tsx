...
const myFaqs = [
  { id: 1, question: "How long does car shipping take?", answer: "Typical car shipping takes 1-7 days depending on distance. Cross-country shipments usually take 5-7 days, while shorter distances can be completed in 1-3 days." },
  { id: 2, question: "Is my car insured during transport?", answer: "Yes, all our carriers are fully insured and licensed. Your vehicle is covered by carrier insurance throughout the entire shipping process." },
  { id: 3, question: "Can I put personal items in my car?", answer: "You can place up to 100 lbs of personal items in the trunk, but they won't be covered by insurance. The items must be below window level." },
  { id: 4, question: "What's the difference between open and enclosed transport?", answer: "Open transport is more economical and exposes your car to weather elements. Enclosed transport provides complete protection from weather and road debris, ideal for luxury or classic cars." },
  { id: 5, question: "How do I prepare my car for shipping?", answer: "Remove personal items, clean your car, document existing damage with photos, ensure the gas tank is 1/4 full, and disable alarms." },
];
    ...
    <main>
      ...
      <section style={{ width: "100%", padding: "40px 20px", background: "#f8fbff", fontFamily: "inter, sans-serif", boxSizing: "border-box" }}>
        <style>{`
          ...
          .hsw-title{color:#0b1e48 !important;font-size:44px !important;font-weight:800 !important;line-height:1.1 !important;letter-spacing:-0.5px !important;margin:0 0 12px !important}
        ...
        <div style={{ textAlign: "center", maxWidth: "700px", margin: "0 auto 50px" }}>
          <h2 className="hsw-title">How Car Shipping Works?</h2>
          <p className="hsw-subtitle">Our streamlined process ensures your vehicle is transported safely and efficiently</p>
        </div>
        <div className="hsw-grid" style={{ maxWidth: "1640px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "30px" }}>
          {[
            { n: "01", t: "Get Your Quote", d: "Fill out our simple form with your car details, pickup and delivery locations. Receive an instant quote tailored to your needs.", i: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2 14 8 20 8" },
            { n: "02", t: "Book Your Shipment", d: "Choose your preferred shipping method (open or enclosed) and schedule your pickup date. We'll assign a professional carrier.", i: "M3 4h18v18H3z M3 10h18" },
            { n: "03", t: "Vehicle Pickup", d: "The assigned carrier will inspect your vehicle and load it onto the transport truck. You may get real-time updates.", i: "M1 3h15v13H1z M16 8h4l3 6v5h-7V8z" },
            { n: "04", t: "Safe Delivery", d: "Your car arrives at the destination on time. Final inspection and delivery to your specified location.", i: "M22 11.08V12a10 10 0 1 1-5.93-9.14 M22 4 12 14.01 9 11.01" },
          ].map((s) => (
            <div key={s.n} className="hsw-card" style={{ position: "relative", background: "#fff", borderRadius: "20px", padding: "30px 24px 28px", boxShadow: "0 10px 30px rgba(11,30,72,0.06)", border: "1px solid #eef2f7", textAlign: "left" }}>
      ...
      <section style={{ width: "100%", padding: "40px 20px", background: "#fff", fontFamily: "'Inter', sans-serif", boxSizing: "border-box" }}>
        ...
        <div className="nat2-wrap" style={{ maxWidth: "1300px", margin: "0 auto", display: "grid", gridTemplateColumns: "380px 1fr", gap: "60px", alignItems: "start" }}>
          <div className="nat2-sticky" style={{ position: "sticky", top: "100px" }}>
            <div style={{ display: "inline-flex", background: "#f1f5f9", border: "1px solid #e2e8f0", padding: "6px 12px", borderRadius: "100px", fontSize: "11px", fontWeight: 700, letterSpacing: "0.8px", color: "#0b1e48" }}>
              <span style={{ width: "8px", height: "8px", background: "#d60000", borderRadius: "50%", display: "inline-block", marginRight: "6px" }}></span> NATIONWIDE SERVICE
            </div>
            <h2 className="nat2-title">Nationwide Auto<br />Transport Made<br />Simple</h2>
            <p className="nat2-desc">Trusted by thousands for safe, fast and affordable vehicle shipping across all 50 states.</p>
            <div style={{ width: "100%", height: "260px", borderRadius: "18px", overflow: "hidden", background: "linear-gradient(135deg,#0b1e48 0%,#1e3a8a 100%)", position: "relative", marginTop: "10px" }}>
              <img src="https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=600&q=80" alt="transport" style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.85 }} />
            </div>
          </div>
          <div className="nat2-timeline" style={{ display: "grid", gap: "0", position: "relative", borderLeft: "1px solid #e2e8f0", paddingLeft: "32px" }}>
            <div className="nat2-row" style={{ position: "relative", padding: "0 0 40px 0" }}>
              ...
              <div className="nat2-num" style={{ position: "absolute", left: "-50px", top: "0", width: "32px", height: "32px", background: "#0b1e48", color: "#fff", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "12px", fontWeight: 800, transition: "all .3s ease" }}>01</div>
              <h3 style={{ margin: "0 0 12px", fontSize: "19px", fontWeight: 700, color: "#0b1e48" }}>Car Shipping Service in the US</h3>
              <p className="nat2-para">The car shipping industry in the United States plays a vital role in helping individuals, dealerships, and businesses move vehicles across the country safely and efficiently. With millions of cars transported every year, auto transport services are essential for relocations, online car sales, seasonal moves, and fleet management. The industry connects customers with licensed carriers who operate nationwide, offering flexible solutions such as open or enclosed transport depending on vehicle type, distance, and budget.</p>
            </div>
            <div className="nat2-row" style={{ position: "relative", padding: "0 0 40px 0" }}>
              <div className="nat2-line" style={{ position: "absolute", left: "-33px", top: "0", width: "2px", height: "32px", background: "#e2e8f0", transition: "all .3s ease" }}></div>
              <div className="nat2-num" style={{ position: "absolute", left: "-50px", top: "0", width: "32px", height: "32px", background: "#0b1e48", color: "#fff", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "12px", fontWeight: 800, transition: "all .3s ease" }}>02</div>
              <h3 style={{ margin: "0 0 12px", fontSize: "19px", fontWeight: 700, color: "#0b1e48" }}>How the Car Shipping Process Works.</h3>
              <p className="nat2-para">The process typically begins with requesting a quote based on vehicle details and pickup and delivery locations. Once the shipment is booked, a carrier is assigned to pick up the vehicle, followed by a pre-shipment inspection and secure loading. During transit, customers can track their shipment and stay in contact with the transport team. Upon arrival, the vehicle undergoes a final inspection and is delivered safely to the specified destination.</p>
            </div>
      ...
      <section style={{ width: "100%", padding: "40px 20px", background: "#f8fafc", fontFamily: "'Inter', sans-serif", boxSizing: "border-box" }}>
        <style>{`
          ...
          @media(max-width:600px){ 
            .cost-grid{grid-template-columns:1fr !important;gap:16px !important} 
          ...
          <div className="cost-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "20px" }}>
            <div className="cost-card" style={{ background: "#fff", borderRadius: "16px", padding: "22px 20px", boxShadow: "0 8px 24px rgba(11,30,72,.05)", border: "1px solid #eef2f7" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "18px" }}>
                <div className="cost-icon" style={{ width: "44px", height: "44px", background: "#d60000", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center" }}>
